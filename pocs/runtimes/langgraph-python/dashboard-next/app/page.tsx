  ...
  return (
    <main>
      <header className="hero">
        <p className="kicker">AnSu v5 · Runtime benchmark</p>
        ...
        <div className="statusGrid">
          <span>
            Runtime <strong>{health?.runtime ?? "—"}</strong>
          </span>
          <span>
        ...
        <p className="note">
          LangSmith sert seulement à visualiser les traces pendant le
          développement. Projet :{" "}
          <code>
            {health?.langsmith?.project ?? "ansu-langgraph-runtime-dev"}
          </code>
        </p>
      </header>
      <AgentPlayground />
