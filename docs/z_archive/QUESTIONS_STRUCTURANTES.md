...
Ce fichier suit les questions qui doivent être résolues pour choisir une architecture AnSu v5. La grille complète est dans [`GRILLE_EVALUATION.md`](./GRILLE_EVALUATION.md).
